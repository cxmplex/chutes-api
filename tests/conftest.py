...
def pytest_configure(config):
    ...
    os.environ.setdefault(
        "CHUTES_NNVERIFY_PATH",
        os.path.abspath("./data/chutes-nnverify.so"),
    )
    ...
    # The repository intentionally contains dev-fleet debug image pins. Unit/integration tests opt
    # into loading them; production keeps the default false and refuses to start with those pins.
