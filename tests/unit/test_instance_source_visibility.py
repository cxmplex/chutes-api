...
from api.instance.schemas import LaunchConfig, LaunchConfigArgs, LaunchConfigResponse
...
def test_launch_config_schemas_have_no_miner_source_submission_field():
    ...
    assert set(LaunchConfigResponse.model_fields) == {
        "token",
        "config_id",
        "registry",
    }
    ...
    }.issubset(set(LaunchConfig.__table__.columns.keys()))
